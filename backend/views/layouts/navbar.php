...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="<?= \yii\helpers\Url::home() ?>" class="nav-link">Panel</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="<?=$assetDir?>/img/usuarios/<?=rtrim(Yii::$app->user->identity->persona->IdPersona)?>.png" class="user-image img-circle elevation-2"
                     alt="Imagen Usuario">
                <span class="d-none d-md-inline"><?= Yii::$app->user->identity->persona->nombreCompleto ?></span>
            </a>
